...
The CLI `lager watt` command returns power (watts) for both devices. The Joulescope JS220's additional measurement capabilities (individual voltage and current readings) are available through the [Python API](/reference/python/watt).
