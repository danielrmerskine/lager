...
description: Integrate energy and charge, and compute power statistics using Joulescope JS220
---

Integrate energy and charge over time, or compute current/voltage/power statistics, from a Joulescope JS220 energy-analyzer net. Requires the `energy-analyzer` net type.
...
The `energy-analyzer` net type is exclusive to the Joulescope JS220. For instantaneous power readings (also available on Yocto-Watt), see [Watt Meter](/source/reference/python/watt).
