...
"""
Comprehensive I2C edge case tests targeting the LabJack T7 adapter on net 'i2c2'.

Run with: lager python test_i2c_labjack.py --box <boxname>

Prerequisites:
- An I2C net configured in /etc/lager/saved_nets.json with instrument "labjack_t7"
...
Optional: BMP280 sensor wired to LabJack I2C for device-specific tests.
...
def main():
    """Run all tests."""
    print("LabJack T7 I2C Comprehensive Test Suite")
