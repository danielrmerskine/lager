...
"""Unit tests for MCP logs tools (cli.mcp.tools.logs)."""
...
class TestLogsTools:
    ...
    def test_clean_default_older_than(self, mock_subprocess):
        from cli.mcp.tools.logs import lager_logs_clean
    ...
    def test_size_with_box(self, mock_subprocess):
        from cli.mcp.tools.logs import lager_logs_size
    ...
    def test_docker_no_container(self, mock_subprocess):
        from cli.mcp.tools.logs import lager_logs_docker
