...
"""Unit tests for MCP power supply tools (cli.mcp.tools.power)."""
...
class TestPowerTools:
    ...
    def test_current_read(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_current
    ...
    def test_enable(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_enable
    ...
    def test_disable(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_disable
    ...
    def test_state(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_state
    ...
    def test_clear_ocp(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_clear_ocp
    ...
    def test_clear_ovp(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_clear_ovp
    ...
    def test_set(self, mock_subprocess):
        from cli.mcp.tools.power import lager_supply_set
