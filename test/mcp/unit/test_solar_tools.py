...
"""Unit tests for MCP solar simulator tools (cli.mcp.tools.solar)."""
...
class TestSolarTools:
    ...
    def test_set(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_set
    ...
    def test_stop(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_stop
    ...
    def test_irradiance_read(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_irradiance
    ...
    def test_mpp_current(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_mpp_current
    ...
    def test_mpp_voltage(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_mpp_voltage
    ...
    def test_resistance_read(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_resistance
    ...
    def test_temperature(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_temperature
    ...
    def test_voc_read(self, mock_subprocess):
        from cli.mcp.tools.solar import lager_solar_voc
