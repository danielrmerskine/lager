...
class TestSpiTools:
    ...
    def test_list_nets(self, mock_subprocess):
        from cli.mcp.tools.spi import lager_spi_list_nets
    ...
    def test_transfer_minimal(self, mock_subprocess):
        from cli.mcp.tools.spi import lager_spi_transfer
    ...
    def test_read_defaults(self, mock_subprocess):
        from cli.mcp.tools.spi import lager_spi_read
    ...
    def test_write(self, mock_subprocess):
        from cli.mcp.tools.spi import lager_spi_write
    ...
    def test_config_all_options(self, mock_subprocess):
        from cli.mcp.tools.spi import lager_spi_config
        lager_spi_config(
            box="DEMO", net="spi1",
